...
![Android 9, WhatsApp v2.20.123](../assets/chat-export-android9-wp2.20.123.gif){ width="300" }

For more details, refer to [official website](https://faq.whatsapp.com/android/chats/how-to-save-your-chat-history/).

## iOS

The chat is exported as a [zip](https://en.wikipedia.org/wiki/Zip_(file_format)), which can be easily unzipped in your computer.

![iOS 17.3.1, WhatsApp v24.5.75](../assets/chat-export-ios17-wp24.5.75.gif){ width="300" }